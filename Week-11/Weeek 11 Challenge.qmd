...
API Key: **ba9885024fd04ffcb3a5e536b097aa8e**
...
```{r}
historic_state_data_url <- "https://api.covidactnow.org/v2/states.timeseries.json?apiKey=ba9885024fd04ffcb3a5e536b097aa8e"
...
# Adjust the size and spacing of the plots
plot_grid(
  fig1 + theme(legend.justification = c(0, 1)),
